import {
  ...
  AlertLink_default,
  Alert_default
} from "./chunk-U76DOUX2.js";
import {
  ToastBody_default,
  ToastHeader_default,
  Toast_default,
  useTimeout
} from "./chunk-7EYU5X6O.js";
import {
  ToastContainer_default
} from "./chunk-UA4WUJ4Q.js";
import {
  ...
  useWaitForDOMRef,
  useWindow
} from "./chunk-REZIX3PR.js";
import {
  divWithClassName_default
} from "./chunk-G6ZWQ2D7.js";
import "./chunk-SRBHBCYG.js";
import {
  CloseButton_default
} from "./chunk-EHGZM5D2.js";
import {
  ...
  Form_default,
  require_warning
} from "./chunk-P63ZYHIW.js";
import {
  Col_default,
  useCol
} from "./chunk-4OWBDMAE.js";
import {
  Button_default as Button_default2
} from "./chunk-S6IFIYDW.js";
import {
  Row_default
} from "./chunk-DAXXQ24E.js";
import {
  TabContainer_default,
  Tab_default
} from "./chunk-JCRZEUB6.js";
import {
...
import {
  ...
  usePrevious
} from "./chunk-C2XHNXFQ.js";
import {
  useMounted
} from "./chunk-GRKOPRSO.js";
import {
  forEach,
  map
} from "./chunk-7JNQOKLJ.js";
import {
  Button_default
} from "./chunk-UEWBOVVR.js";
import {
  ...
  makeEventKey,
  useUncontrolledProp
} from "./chunk-UO6633HE.js";
import "./chunk-OKWYS734.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
import {
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-KV6HSXK4.js";
import {
  require_jsx_runtime
} from "./chunk-YFKKR4WC.js";
import {
  require_react_dom
...
var CardImgOverlay = React19.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React20.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React21.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React22.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var InputGroupText = React49.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime50.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames40.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var NavbarBrand = React53.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React54.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime54.jsx)(Collapse_default, {
...
var NavbarToggle = React55.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime55.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime55.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react24.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react25.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React56.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React57.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime57.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React57.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React58.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React59.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime60.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React60.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react26.useCallback)((backdropProps) => (0, import_jsx_runtime60.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime62.jsxs)(import_jsx_runtime61.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime60.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React61.forwardRef((props, ref) => {
  const context4 = (0, import_react27.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime63.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React62.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React63.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  return (0, import_jsx_runtime65.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime65.jsx)(SelectableContext_default.Provider, {
...
var NavDropdown = React64.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime67.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames52.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime66.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React65.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React66.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React67.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React69.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime71.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime70.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime70.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React70.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime73.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime72.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime72.jsx)("div", {
...
var Overlay2 = React71.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime74.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React71.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React72.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react33.cloneElement)(children, triggerProps), (0, import_jsx_runtime75.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React73.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button = React73.forwardRef(({
    children,
    ...props
...
var Pagination = React74.forwardRef(({
  bsPrefix,
  className,
  size,
  ...props
  ...
  return (0, import_jsx_runtime80.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames59.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames60.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React75.forwardRef((props, ref) => {
...
var Placeholder = React76.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var Ratio = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsx)("div", {
    ...
    children: React78.Children.only(children)
  });
});
...
var Spinner = React79.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
  ...
  return (0, import_jsx_runtime85.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames63.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React80.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime87.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime86.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime86.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
...
var Table = React82.forwardRef(({
  ...
  const classes = (0, import_classnames65.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime89.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
var noop5 = () => void 0;
var ToggleButton = React83.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React84.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
...
//# sourceMappingURL=react-bootstrap_.js.map
