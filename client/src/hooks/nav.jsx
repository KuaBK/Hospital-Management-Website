...
function Nav() {
    ...
    const handleUser = async () => {
        await axios.get("https://hospital-management-website-v6hl.onrender.com/user", {
          params: {
            tokenUser: tokenUser
          }
        }).then(res => {
    ...
    const handleSignOut = async () => {
        await axios.get("https://hospital-management-website-v6hl.onrender.com/user/signout", {
            headers: {
