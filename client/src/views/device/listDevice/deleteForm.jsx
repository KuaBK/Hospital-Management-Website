...
function DeleteForm({showDelete, setShowDelete, ID, setID, searchValue, setLoading, setSearchResult}) {
    ...
    const handleSubmitDelete = async () => {
        await axios.delete("https://hospital-management-website-gude.onrender.com/device/delete/", {
            params: {
                id: ID
            }
        })
        setNotification("Xóa thiết bị thành công");
        setShowSuccess(true);
        handleCloseDelete();
    ...
    return (
        <>
            <Modal show={showDelete} onHide={handleCloseDelete} style={{top: "30%"}}>
                ...
                <Modal.Body>Bạn có chắc muốn xóa thiết bị này khỏi hệ thống?</Modal.Body>
                <Modal.Footer>
