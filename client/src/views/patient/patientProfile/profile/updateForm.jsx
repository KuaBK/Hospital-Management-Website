...
function UpdateForm({data, showUpdateProfile, setShowUpdateProfile}) {
    ...
    const handleSubmitUpdate = async () => {
        await axios.patch("https://hospital-management-website-v6hl.onrender.com/patient/update", {
            data: {
                id: data._id,
                name: name,
                age: age,
    ...
    return (
        <>
            <Modal size="lg" show={showUpdateProfile} onHide={handleCloseUpdate} style={{top: "20%"}}>
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group as={Row} className="mb-3" controlId="genderForm">
                            ...
                            <Col sm="5">
                                <Form.Select defaultValue={data.status}  onChange={e => handleStatus(e)}>
                                    <option value="Đang điều trị">Đang điều trị</option>
                                    <option value="Đã điều trị">Đã điều trị</option>
                                </Form.Select>
                            </Col>
                        </Form.Group>
                    </Form>
